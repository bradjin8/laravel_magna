        ...
        const popupMenus = {
            'Forward Lighting': [
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Forward_Spotlight.jpg",
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Invision.jpg",
            ...
            'Decorative Lighting': [
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Lit_Trim.jpg",
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Projection_Logo_Ground_Illumination.jpg",
            ...
            'Communication Lighting': [
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Lit_Pillar_Applique.jpg",
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Turn_Signal_Clearance.jpg",
            ...
            'Interior Lighting': [
                ...
                {
                    title: 'ISELED',
                    image: "{{url('/public/front')}}/media/intelligent-lighting/ISELED.jpg",
                    subtitle: 'ISELED',
            ...
            'Rear Lighting': [
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Evenly_Lit_Function.jpg",
                    subtitle: 'Evenly Lit Function',
                    description: 'Homogenous styling appearance that meets OEM requirements.'
                },
                {
                    title: 'FLECSFORM™',
                    image: "{{url('/public/front')}}/media/intelligent-lighting/flecsform.jpg",
                    subtitle: 'FLECSFORM™',
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Integrated_CHMSL_Lighting.jpg",
                    subtitle: 'Integrated CHMSL Lighting',
                    description: 'Addition of exterior and/or interior lighting to rear truck windows.'
                },
                {
                    title: 'OLED',
                    image: "{{url('/public/front')}}/media/intelligent-lighting/OLED.jpg",
                    subtitle: 'OLED',
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Reverse_Light.jpg",
                ...
                },
                {
                    ...
                    image: "{{url('/public/front')}}/media/intelligent-lighting/Surface_Element_Lighting.jpg",
